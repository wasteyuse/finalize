...
const Index = () => {
  ...
  const thumbnails = ["/lovable-uploads/382be783-f28d-4d1b-866e-ba24b615f0e1.png", "/lovable-uploads/ca028cff-8c40-4cd4-8e85-ff5db5092225.png", "/lovable-uploads/430a706e-02c6-41f2-93b7-809ae39ee122.png", "/lovable-uploads/26d78a33-1d58-44e9-9db6-367aa3882f93.png"];
  const features = ["📱 1080P HD Display Resolution", "🔋 1200mAh Long-Lasting Battery", "🔄 Auto-Rotate Function", "🔊 Adjustable Volume Control", "⚡ Type-C Fast Charging", "🎞️ Photo & Video Support"];
  const product = {
    id: "1pack",
  ...
  return <div className="flex flex-col min-h-screen">
      ...
      <div className="container max-w-5xl px-4 py-8 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div>
            <ProductInfo title="Digital Photo Frame 7&quot; HD" subtitle="NEWEST MODEL WITH ACRYLIC DESIGN" rating={4.8} reviews={1237} originalPrice={129} salePrice={89} discount={31} features={features} />
            <ProductVariants product={product} bonusImage="/lovable-uploads/c34cdfc8-bd6c-4148-933c-b52fb94cac87.png" paymentMethodsImage="/lovable-uploads/bf3df539-4f44-4259-b843-84a24c3df34a.png" />
          </div>
        </div>
